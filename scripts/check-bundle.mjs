...
// left out, it is published. It did: node_modules/ (113 tracked files, playwright-core
// included) and package.json were both live on etapp.tor2dbear.com, verified 200, until
// this started running. Kept in sync by hand with the copy in tor2dbear/roadmap.
//
...
export const SERVED = {
  ...
  "demo/data": /^demo\/data\/roadmap\.(json|js)$/,
  ...
  "demo/fonts": /^demo\/fonts\/([\w.-]+\.woff2|LICENSE\.md)$/,
};
